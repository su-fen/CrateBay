...
(function () {
  ...
  const i18n = {
    en: {
      ...
      heroTitle2: 'Bay',
      heroTagline:
        'The open-source desktop app for containers, Linux VMs, Kubernetes \u2014 and self-hosted AI infrastructure.',
    ...
    zh: {
      ...
      heroTitle1: 'Crate',
      heroTitle2: 'Bay',
      heroTagline: '开源桌面应用，统一管理容器、Linux 虚拟机、Kubernetes，并延伸为自托管 AI 基础设施。',
